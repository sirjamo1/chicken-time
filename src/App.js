...
function App() {
    ...
    const handleTimeCalc = () => {
        ...
        setPreheat(
            (preHour > 12 ? preHour - 12 : preHour) +
                ":" +
                (preRemainder < 10 ? "0" + preRemainder : preRemainder)
        );
        setChickenIn(
            (chickInHour > 12 ? chickInHour - 12 : chickInHour) +
                ":" +
                (chickInRemainder < 10
                    ? "0" + chickInRemainder
                    : chickInRemainder)
        ...
        setVeggiesIn(
            (veggiesHour > 12 ? veggiesHour - 12 : veggiesHour) +
                ":" +
                (veggiesRemainder < 10
                    ? "0" + veggiesRemainder
                    : veggiesRemainder)
